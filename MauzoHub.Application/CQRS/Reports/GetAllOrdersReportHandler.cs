...
{
    public class GetAllOrdersReportHandler : IRequestHandler<GetAllOrdersReport, IEnumerable<OrderDto>>
    {
        private readonly ICheckoutOrderRepository _checkoutOrderRepository;
        private readonly IHttpContextAccessor _httpContextAccessor;
        public GetAllOrdersReportHandler(ICheckoutOrderRepository checkoutOrderRepository, IHttpContextAccessor httpContextAccessor)
        {
            _checkoutOrderRepository = checkoutOrderRepository;
            _httpContextAccessor = httpContextAccessor;
        }

        public async Task<IEnumerable<OrderDto>> Handle(GetAllOrdersReport request, CancellationToken cancellationToken)
        {
            ...
            try
            {
                var reports = await _checkoutOrderRepository.GetAllAsync();
