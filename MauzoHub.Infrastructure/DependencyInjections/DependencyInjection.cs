    ...
    public static class DependencyInjection
    {
        public static void ConfigureInfrastructureServices(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            services.Configure<MauzoHubDatabaseSettings>(options =>
            {
                ...
                options.CheckoutCollectionName = configuration.GetSection("MauzoHubDatabase:CheckoutCollectionName").Value!;
            ...
            services.AddScoped<ICheckoutOrderRepository, CheckoutOrderRepository>();
